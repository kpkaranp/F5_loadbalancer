...
def main():
    ...
    username = args.username or os.environ.get('F5_USERNAME')
    password = args.password or os.environ.get('F5_PASSWORD')
    if not username or not password:
        raise ValueError("F5_USERNAME and F5_PASSWORD environment variables must be set, or pass --username and --password arguments.")
